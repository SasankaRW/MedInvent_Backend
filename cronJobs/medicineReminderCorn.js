       ...
       console.log("Cron job started");
        ...
        const sendReminders = async () => {
            ...
            for(let w=0;w<getDependPres.length;w++){
                let getDependPresNames = await DataBase.findDependPrescriptionFNames(getDependPres[w].dID);
                                    ...
                                    for(let z=0;z<getUserPres[i].presMedicine.length;z++)
                                        {
                                            ...
                                            finalMedMealTimeList.push(getUserPres[i].presMedicine[z].mealTiming);
                                        }
                                }
                        }
                    }
